...
캡처: `docs/캡처/15-step6-actuator-ai-tokens.jpg`

![Step 6 — 계측](캡처/15-step6-actuator-ai-tokens.jpg)
...
| 8 | 계측 | 토큰·지연·도구 지표가 쌓인다 | ✅ | `4676f8c`. `docs/캡처/15-step6-actuator-ai-tokens.jpg` — `GET /actuator/metrics/ai.tokens` COUNT 8309(누적), `ai.latency` COUNT 11 |
